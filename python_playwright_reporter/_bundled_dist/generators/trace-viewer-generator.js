...
exports.generateJSZipScript = generateJSZipScript;
exports.generateTraceViewerHtml = generateTraceViewerHtml;
exports.generateTraceViewerStyles = generateTraceViewerStyles;
exports.generateTraceViewerScript = generateTraceViewerScript;
const jszip_source_1 = require("../vendors/jszip-source");
/**
 * Generate the inlined JSZip script
 * This must be included before generateTraceViewerScript() in the HTML
 */
function generateJSZipScript() {
    return `
    // JSZip v3.10.1 - inlined for self-contained reports
    ${jszip_source_1.JSZIP_SOURCE}
  `;
}
/**
 * Generate the embedded trace viewer HTML and styles
 */
function generateTraceViewerHtml() {
    return `
 ...
 */
function generateTraceViewerStyles(monoFont) {
    return `
    /* Trace Viewer Modal */
    .trace-modal {
      display: none;
 ...
 */
function generateTraceViewerScript() {
    return `
    // Trace Viewer State
    let traceData = null;
    let traceResources = {};
