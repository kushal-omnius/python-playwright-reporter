...
from python_playwright_reporter.bridge import (
    _find_monorepo_root,
    _get_dist_root,
    _is_valid_root,
)
...
class TestGetDistRoot:
    def test_prefers_bundled_over_monorepo(self, tmp_path):
        ...
        with patch(
            "python_playwright_reporter.bridge.__file__",
    ...
    def test_falls_back_to_monorepo(self, tmp_path):
        ...
        with patch(
            "python_playwright_reporter.bridge._find_monorepo_root",
...
class TestFindMonorepoRoot:
    def test_returns_none_when_not_in_monorepo(self):
        with patch(
            ...
            with patch("python_playwright_reporter.bridge.Path.cwd") as mock_cwd:
...
class TestSmartReporterBridge:
    def test_node_failure_raises(self, tmp_path, sample_report_path):
        from python_playwright_reporter.bridge import SmartReporterBridge
